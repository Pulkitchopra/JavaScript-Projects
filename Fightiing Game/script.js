...
let player1 = new Player('Pulkit', 100, 10)
let player2 = new Player('Vivek', 100, 10)
...
if (e.key == 'v' && p1.health > 0 && game.isOver == false){
...
document.addEventListener('keydown', function(e) {
  ...
  if(e.key == 's' && p1.health > 0 && game.isOver == false){
